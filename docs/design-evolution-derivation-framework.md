...
**核心概念**：`Principle + Modifications → Derived Form`
...
2. **Stephen Diehl - sympy-mcp 專案**
   - 論文：["The Future of Math is Weird"](https://www.stephendiehl.com/posts/future_math_weird/)
   - GitHub: https://github.com/sdiehl/sympy-mcp
   - 啟發：LLM 不擅長符號運算，應該用專門工具（sympy）
...
- 原始設計：[docs/template-system-design.md](./template-system-design.md)
- 架構文檔：[memory-bank/architect.md](../memory-bank/architect.md)
- 決策日誌：[memory-bank/decisionLog.md](../memory-bank/decisionLog.md)
- sympy-mcp 發現：[memory-bank/research/sympy-mcp-discovery.md](../memory-bank/research/sympy-mcp-discovery.md)
